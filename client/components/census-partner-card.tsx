...
function CensusPartnerCard() {
  return (
    <div className="w-full max-w-xl md:max-w-4xl mx-auto m-2 p-6 bg-white/10 rounded-3xl backdrop-blur-lg flex flex-col items-center gap-4 md:flex-row md:justify-between">
